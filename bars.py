...
class DataBase():
    def __init__(self,ticker,days):
        ...
        data=pdr.get_data_yahoo(stockChoice, startDate,endDate)
...
ax1.plot(dateLister,buy_signals,'o',data=df, linewidth=0.9, color='green')
ax1.plot(dateLister,priceSeller,'o',data=df, linewidth=0.9, color='red')

# k
# ax1.plot(dateLister2,buy_signals2,'o',data=df, linewidth=0.9, color='black')
# ax1.plot(dateLister2,priceSeller2,'o',data=df, linewidth=0.9, color='orange')
